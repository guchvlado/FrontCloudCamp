import { InputHTMLAttributes, forwardRef, DetailedHTMLProps, TextareaHTMLAttributes } from "react";
...
export const TextArea = forwardRef(({ className, id, label, counter = false, error, value, ...props}: InputProps, forwardRef) => {
    ...
    return (
        <div className={styles.root}>
            ...
            {counter && <div className={styles.counter}>Кол-во символов без пробелов: {value ? value.toString().replace(/ /g, '').length : 0}</div>}
